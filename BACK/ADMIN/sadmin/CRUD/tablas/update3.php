...
//Si se hace clic en el botón de actualización del formulario, debemos procesar el formulario.
	if (isset($_POST['update'])) {
		...
		if ($result == TRUE) {
			header("Location: Tusuario.php?pagina=1");
		}else{
...
<br>
<h4 class="text-primary">Tipo de Rol</h4>
<center>
...
<center> <input type="submit"  class="btn btn-success" value="Enviar" name="update"><br><br>
		    <a class="btn btn-info text-light" href="Tusuario.php?pagina=1">Cancelar</a></td></center>
