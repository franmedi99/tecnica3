...
$sql= 'SELECT *FROM usuarios where roles=4';
...
<center><h1>Tabla de Usuarios deshabilitados</h1><br><br>
...
$sql_articulos ='SELECT * FROM usuarios where roles=4 LIMIT :iniciar,:narticulos';
...
<?php foreach($resultado_articulos as $row): ?>
					...
					<td><a class="btn btn-info" href="update4.php?id=<?php echo $row['id']; ?>">Editar</a>
						<a class="btn btn-warning" href="rea.php?id=<?php echo $row['id']; ?>">Rehabilitar</a></td>
					</tr>	
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    ">
      ...
      <a class="page-link" href="Tdes.php?pagina=<?php echo $_GET['pagina']-1 ?>">
      Anterior 
    </a> 
    ...
    <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
      <a class="page-link" href="Tdes.php?pagina=<?php echo $i+1 ?>">
    <?php echo $i+1 ?>
  </a></li>
