...
//Si se hace clic en el botón de actualización del formulario, debemos procesar el formulario.
	if (isset($_POST['update'])) {
		...
		if ($result == TRUE) {
			header("Location: Tdes.php?pagina=1");
		}else{
...
if (isset($_GET['id'])) {
	...
	<link rel="stylesheet" href="bootstrap.min.css">
		<center><h1>Rehabilitar Usuario</h1></center>
		<hr>
		<form action="" method="post">
		  <fieldset>
		    <legend></legend>

		    <center><h1>Estas seguro que deseas Rehabilitar a <?php echo $user; ?> ?</h1></center><br><br>

		    <center><h2 class="text-info">El usuario <?php echo $user; ?> sera rehabilitado con el rol de Usuario.</h2></center>
		    <center><h2 class="text-success">El ID de <?php echo $user; ?> es <?php echo $id; ?>. </h2></center>
...
<center><input type="text" hidden name="roles" value="3" placeholder="roles"> 

<center> <input type="submit"  class="btn btn-success" value="Aceptar" name="update">
		    <a class="btn btn-warning text-light" href="Tdes.php?pagina=1">Cancelar</a></td></center>
