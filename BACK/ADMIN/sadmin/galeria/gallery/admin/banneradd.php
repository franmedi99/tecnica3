...
$insert=mysqli_query($con,"INSERT INTO banner (url_image, estado, id_usuarios) VALUES ('$imagen_demo','0', '$id_usuarios')");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar imagen</h3>
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 100%;" >
									  <img class="img-rounded" src="../../../../sadmin/galeria/gallery/img/banner/<?php echo $url_image;?>" />
								  </div>
	...
	<script src="js/prueba-bootstrap.min.js"></script>
